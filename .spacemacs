...
before packages are loaded."
  ...
  (with-eval-after-load 'org
    ...
    (setq org-todo-keyword-faces
          (quote (("TODO" :foreground "red" :weight bold)
                  ...
                  ("PLANNED"    :foreground "gold"         :weight bold)
                  ("MAYBE" :foreground "dark red"     :weight bold)
                  ("DEFERRED" :foreground "red"     :weight bold)
                  ("ACCOMPLISHED" :foreground "sea green"    :weight bold)
                 ))
          )
  ...
  (setq evil-org-set-key-theme '(textobjects insert navigation additional shift todo heading))
  ...
  (spacemacs/set-leader-keys-for-major-mode 'org-mode "gl" 'goto-last-heading)
